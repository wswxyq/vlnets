...
#include "dunereco/VLNets/art/var_extractors/EventGVarExtractor.h"
...
private:
    ...
    EventGVarExtractor       gVarExtractor;
...
VLNEnergyDataGen::VLNEnergyDataGen(const fhicl::ParameterSet &pset)
  : EDAnalyzer(pset),
    ...
    gVarExtractor("g.", pset.get<std::string>("LabelGenerator")),
...
void VLNEnergyDataGen::analyze(const art::Event &evt)
{
    ...
    gVarExtractor.extract(evt, vars);
